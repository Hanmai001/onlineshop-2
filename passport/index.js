...
passport.serializeUser(function (user, cb) {
    process.nextTick(function () {
        cb(null, { id: user.ID, username: user.USERNAME, email: user.EMAIL, ava: user.AVATAR, admin: user.ADMIN, fullname: user.FULLNAME, phone: user.PHONE, sex: user.SEX, ban: user.BAN});
    });
});
